...
[Files]
Source: "..\dist\windows\music-sync-server-win32-x64\*"; Excludes: "..\dist\windows\music-sync-server-win32-x64\settings"; DestDir: "{app}"; Flags: recursesubdirs ignoreversion
